...
public class PracticeUserAndPassword {
	...
	public static void main(String[] args) {
		...
		if (userName.isEmpty() || password.isEmpty()) {
			...
			System.out.println("Your username and password has been created your name is "+userName+" and your password is "+password);
